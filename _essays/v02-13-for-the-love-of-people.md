...
![Group of four photographs. Top left shows a dance class. Top right shows James Baldwin with Mary Ann Pollar. Bottom left shows Shirley Chisholm at Rainbow Sign. Bottom right shows Herman Kofi Bailey shaking Mary Ann Pollar's hand.](/assets/img/v02/saul/figure1.png)
{% endfigure %}
...
![A screenshot of the homepage for The Berkeley Revolution project.](/assets/img/v02/saul/figure3.png)
{% endfigure %}
...
![Screenshot of the homepage of the Rainbow Sign project.](/assets/img/v02/saul/figure4.png)
{% endfigure %}
...
![Screenshot showing one of the annotated sources used in the Rainbow Sign project. This page features a photograph and text about dance classes that took place at Rainbow Sign.](/assets/img/v02/saul/figure5.png)
{% endfigure %}
...
![Four screenshots of primary source cluster pages.](/assets/img/v02/saul/figure6.png)
{% endfigure %}
